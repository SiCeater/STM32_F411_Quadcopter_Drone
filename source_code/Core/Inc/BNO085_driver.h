...
#define BNO080_SPI_SCLK_PIN		LL_GPIO_PIN_5
#define BNO080_SPI_SCLK_PORT	GPIOA
#define BNO080_SPI_SCLK_CLK		LL_AHB1_GRP1_PERIPH_GPIOA

#define BNO080_SPI_MISO_PIN		LL_GPIO_PIN_6
#define BNO080_SPI_MISO_PORT	GPIOA
#define BNO080_SPI_MISO_CLK		LL_AHB1_GRP1_PERIPH_GPIOA

#define BNO080_SPI_MOSI_PIN		LL_GPIO_PIN_7
#define BNO080_SPI_MOSI_PORT	GPIOA
#define BNO080_SPI_MOSI_CLK		LL_AHB1_GRP1_PERIPH_GPIOA

#define BNO080_SPI_CS_PIN		  LL_GPIO_PIN_4
...
#define MAX_PACKET_SIZE 500 //Packets can be up to 32k but we don't have that much RAM.
